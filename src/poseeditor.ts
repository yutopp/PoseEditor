...
module PoseEditor {
    export class Editor {
        ...
        private makeDataUrl(type: string): string {
            ...
            //
            //if (this.logoRenderer) {
            //    this.logoRenderer.visible = true;
            //}
            ...
            try {
                ...
                //if (this.logoRenderer) {
                //    this.logoRenderer.visible = false;
                //}
        ...
        //
        private sceneForLogo: THREE.Scene;
        private cameraForLogo: THREE.Camera;
        private logoRenderer: LogoRenderer = null;
